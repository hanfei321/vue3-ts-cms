<template>
  <div class='overview'>
    <hy-card title='关于'>
      <div class='c-left'>
        Vue3Admin 是基于 Vue3、Vuex、VueRouter、Webpack、 ElementPlus 、TypeScript、Echart5
        等后台系统解决方案。
      </div>
    </hy-card>
    <hy-card title='技术栈'>
...
import HyDescriptions from '@/base-ui/descriptions/index'
import HyTextLink from '@/base-ui/text-link/index'
import HyCode from '@/base-ui/code/index'
